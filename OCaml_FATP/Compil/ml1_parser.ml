...
let ml_parser =
  ...
  and mult =
    let rec restmult e1 =
      parser
    | [< 'MULT; e2 = app;
         e = (restmult (Ml_binop (Ml_mult, e1, e2))) >]
      -> e
    | [< >] -> e1
  ...
  and add =
    let rec restadd e1 =
      parser
    | [< 'PLUS; e2 = mult;
         e = (restadd (Ml_binop (Ml_add, e1, e2))) >]
      -> e
    | [< 'MINUS; e2 = mult;
         e = (restadd (Ml_binop (Ml_sub, e1, e2))) >]
      -> e
    | [< >] -> e1
  ...
  and comp =
    let rec restcomp e1 =
      parser
    | [< 'EQ; e2 = atom;
         e = (restcomp (Ml_binop (Ml_eq, e1, e2))) >]
      -> e
    | [< 'LT; e2 = atom;
         e = (restcomp (Ml_binop (Ml_less, e1, e2))) >]
      -> e
    | [< >] -> e1
