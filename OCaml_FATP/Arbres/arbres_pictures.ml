...
let t = parse_btree parse_string_int
    "[Matisse; 1869] ([Degas; 1834] ([Boudin; 1824] ([Bonnard; 1867], [Braque; 1882]), [Gauguin; 1848] ([Derain; 1880], [Jongkind; 1819])), [Seurat; 1863]\
     ([Pissaro; 1830] ([Monet; 1840], [Redon; 1840]), [Sisley; 1839] ([Signac; 1863], [Vuillard; 1868])))"
in let p = make_btree_picture
...
let a2= add_bottom_to_bst (fun x _y -> x) int_comp a1 15 in
let a3= add_bottom_to_bst (fun x _y -> x) int_comp a2 12 in
let a4= add_bottom_to_bst (fun x _y -> x) int_comp a3 4 in
let a5= add_bottom_to_bst (fun x _y -> x) int_comp a4 6 in
let a6= add_bottom_to_bst (fun x _y -> x) int_comp a5 21 in
let a7= add_bottom_to_bst (fun x _y -> x) int_comp a6 8 in
let a8= add_bottom_to_bst (fun x _y -> x) int_comp a7 1 in
let a9= add_bottom_to_bst (fun x _y -> x) int_comp a8 17 in
let a10= add_bottom_to_bst (fun x _y -> x) int_comp a9  2 in
let p=
  align_vertically Align_Left
    [align_horizontally Align_Top
       (List.map (extend_picture_frame Left_ext 0.4
                  % (make_btree_picture
                       (draw_int_node 8.0)
                       (2.2,1.8) black ))
...
in let t1, _x, t2 = cut_bst int_comp 11 t
in let p= make_btree_picture
       (draw_int_node 8.0)
       (2.2,1.8) black t
...
(** +BSTconstr2+ *)
let int_comp = mk_preorder ( ( < ), ( = ) )  ;;
let a1 = Bin(Empty,10,Empty)
in let a2= add_root_to_bst (fun x _y -> x) int_comp 15 a1
in let a3= add_root_to_bst (fun x _y -> x) int_comp 12 a2
in let a4= add_root_to_bst (fun x _y -> x) int_comp 4 a3
in let a5= add_root_to_bst (fun x _y -> x) int_comp 6 a4
in let a6= add_root_to_bst (fun x _y -> x) int_comp 21 a5
in let a7= add_root_to_bst (fun x _y -> x) int_comp 8 a6
in let a8= add_root_to_bst (fun x _y -> x) int_comp 1 a7
in let a9= add_root_to_bst (fun x _y -> x) int_comp 17
       a8
in let a10= add_root_to_bst (fun x _y -> x) int_comp
       2 a9
in let p=
     align_vertically Align_Left
       [align_horizontally Align_Top
...
(** +BSTrem+ *)
let a1 = mk_bst (fun x _y -> x) int_comp [10;15;12;4;6;21;3]
...
(** +degen+ *)
let t = mk_bst (fun x _y -> x) int_comp [10;7;2;5;3]
in let p= make_btree_picture
       (draw_int_node 8.0)
       (2.2,1.8) black t
...
and p4= make_btree_picture
    (draw_int_node 8.0)
    (2.2,1.8) black t4
and _pb = make_blank_picture (50.0,50.0)
and arrow = make_arrow_picture 50. 10. 1. 3. black
...
let t = mk_avl (fun x _y -> x) int_comp [2;1;20;11;21;6;15;4;8;12;17;3;5;7;9]
in let p = make_btree_picture
...
let a2= add_to_avl (fun x _y -> x) int_comp a1 15 ;;
let a3= add_to_avl (fun x _y -> x) int_comp a2 12 ;;
let a4= add_to_avl (fun x _y -> x) int_comp a3 4 ;;
let a5= add_to_avl (fun x _y -> x) int_comp a4 6 ;;
let a6= add_to_avl (fun x _y -> x) int_comp a5 21 ;;
let a7= add_to_avl (fun x _y -> x) int_comp a6 8 ;;
let a8= add_to_avl (fun x _y -> x) int_comp a7 1 ;;
let a9= add_to_avl (fun x _y -> x) int_comp a8 17 ;;
let a10= add_to_avl (fun x _y -> x) int_comp a9 2 ;;
  ...
  align_vertically Align_Left
    [align_horizontally Align_Top
       (List.map (extend_picture_frame Left_ext 0.4
          ...
          [a1;a2;a3;a4;a5;a6;a7]);
     align_horizontally Align_Top
       (List.map (extend_picture_frame Left_ext 0.2
                  % (make_btree_picture
                       (draw_avl_int_node 8.0)
                       (2.2,1.8) black))
          [a8;a9;a10])]
